...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=125mm]{./images/OverallQRCodeDownload}
	\caption{Overall QR Code Scans}
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=125mm]{./images/threkeld-scans}
	\caption{QR Code - Threlkeld Scans}
	\label{QR-threkeld}
\end{figure}
